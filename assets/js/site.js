(function () {
  ...
  const I18N = {
    en: {
      ...
      flowTab4: "Widget",
      widgetKicker: "Glanceable, even off the app",
      widgetTitle: "Home-screen widget",
      widgetDesc: "A two-cell widget lives on your home screen: today's plan with first-class and last-class times on the left, the next class with a live countdown on the right. Theme follows the app, refreshes on its own, bilingual.",
      widgetNote: "Counts, times, and rooms keep updating without opening the app.",
    ...
    zh: {
      ...
      flowTab3: "定制",
      flowTab4: "小组件",
      widgetKicker: "不打开应用也能看",
      widgetTitle: "桌面小组件",
      widgetDesc: "两格桌面卡片：左边是今天安排与最早上课、最晚下课时间，右边是下一节课和实时倒计时。主题跟随应用设置，数据自动刷新，中英双语。",
      widgetNote: "课程数、时间、教室，不打开应用也会自动更新。",
