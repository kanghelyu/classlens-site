(function () {
  ...
  const I18N = {
    en: {
      ...
      feat3Desc: "Adjust background blur, scrim and glass material, plus row height, text size, header dates, end times and more — from real-time liquid glass to frosted panels.",
      flowTab4: "Desktop AI",
      ...
      whatsNewSummary: "v1.0.15 \u2014 full period time ranges and dates in the header, up to 30 periods with a self-fitting grid, a liquid-glass current-time bar, and 43 MCP tools with no notification.",
    ...
    zh: {
      ...
      feat3Title: "液态玻璃外观",
      feat3Desc: "可调背景模糊、背景遮罩、玻璃材质，以及行高、字号、顶栏日期、下课时间等——从实时液态玻璃到玻璃磨砂。",
      flowTab4: "桌面端 AI",
      ...
      whatsNewSummary: "v1.0.15 —— 时间栏显示完整时间段、顶栏带日期、最多 30 节并自适应、液态玻璃「现在」指示条，以及 43 个 MCP 工具且不占用通知栏。",
